...
-- ----------------------------
BEGIN;
INSERT INTO `sys_roles` (`id`, `created_at`, `updated_at`, `status`, `name`, `code`, `default_router`, `remark`, `sort`) VALUES (1, '2025-09-09 10:23:13', '2025-10-28 10:08:02', 1, 'role.admin', '001', 'dashboard', '超级管理员', 1);
