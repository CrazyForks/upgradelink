...
func NewInternalUploadLogic(r *http.Request, svcCtx *svc.ServiceContext) *InternalUploadLogic {
...
func (l *InternalUploadLogic) UploadToProvider(file multipart.File, fileName, provider string) (url string, err error) {
