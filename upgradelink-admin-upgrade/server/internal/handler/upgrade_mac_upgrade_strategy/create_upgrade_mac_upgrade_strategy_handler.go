...
// swagger:route post /upgrade_mac_upgrade_strategy/create upgrade_mac_upgrade_strategy CreateUpgradeMacUpgradeStrategy
//
// Create upgrade mac upgrade strategy information | 创建UpgradeMacUpgradeStrategy信息
//
// Create upgrade mac upgrade strategy information | 创建UpgradeMacUpgradeStrategy信息
//
// Parameters:
