...
// swagger:route post /upgrade_mac_upgrade_strategy/delete upgrade_mac_upgrade_strategy DeleteUpgradeMacUpgradeStrategy
//
// Delete upgrade mac upgrade strategy information | 删除UpgradeMacUpgradeStrategy信息
//
// Delete upgrade mac upgrade strategy information | 删除UpgradeMacUpgradeStrategy信息
//
// Parameters:
